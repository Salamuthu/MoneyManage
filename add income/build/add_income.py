...
from db import connect_db, get_today_total_incomes, get_today_total_expenses
...
# Button 2: Add Income (Current Page - Just prints)
...
button_2 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: print("Already on Add Income"),
    relief="flat",
    bg="#757575",
...
category_values = ["Salary", "Freelancing", "Bonus", "Gift", "Interest", "Other"]
entry_4 = Combobox(
...
def save_income():
    ...
    try:
        ...
        query = """
            INSERT INTO income (amount, category, note, date_entry, time_entry, user_id)
            VALUES (%s, %s, %s, %s, %s, %s)
            """
